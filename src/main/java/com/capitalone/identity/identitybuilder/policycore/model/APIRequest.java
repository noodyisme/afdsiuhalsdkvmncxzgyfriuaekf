...
public class APIRequest {
    ...
    @ApiParam(value = "Fallback Flag for Mock execution")
    Boolean mockModeFlag;

    public APIRequest(@HeaderParam("Api-Key") String apiKey, @HeaderParam("Client-Api-Key") String clientApiKey, @HeaderParam("Client-Correlation-Id") String clientCorrelationId, //NOSONAR
                      ...
                      @HeaderParam("x-journey-policy") String xJourneyPolicy, @HeaderParam("customerIdToken") String customerIdToken, @HeaderParam("session-correlation-id") String sessionCorrelationId, @PathParam("policy") String policyName, @PathParam("version") String policyVersion,
                      @PathParam("resourceId") String processId, @QueryParam("step") String step, @HeaderParam("policy-core.mockMode") Boolean mockModeFlag) {
        this.apiKey = apiKey;
